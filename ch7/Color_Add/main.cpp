...
CBOARD                  g_TextureDebug_Green;         //          // 显示的物体
    ...
    if( SUCCEEDED( pd3dDevice->BeginScene() ) )
      {
        ...
        D3DPERF_BeginEvent( D3DCOLOR_XRGB( 0, 255, 0 ), L"RenderObject" );
          {
        g_TextureDebug_Red.OnFrameRender( pd3dDevice ,NULL , 0 , fTime ); // 红色
        g_TextureDebug_Green.OnFrameRender( pd3dDevice ,NULL , 0 , fTime ); // 黄色
          }
        D3DPERF_EndEvent( );
