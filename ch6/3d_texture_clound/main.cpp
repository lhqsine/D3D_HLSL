...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
  {
    ...
    DXUTCreateWindow( L"3d_TEXTURE_CLOUND" );
...
void CALLBACK OnFrameMove( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime )
  {
    ...
    // 物体绕 Y 轴旋转
    D3DXMatrixRotationY( &mWorld ,fTime/3.0 );
	    // 由用户的鼠标控制
    ...
    g_RenderObject_Ground.OnFrameMove( &mWorld ,&mView ,&mProj ,fTime  );
    //// 设置灯光位置给受光物体，同时给灯光物体
	...
	g_RenderObject_Box.OnFrameMove( &mWorld ,&mView ,&mProj ,fTime  );
  }
