...
float4   g_vVectorArray[ INSTANCENUM ]; // x y z 分别保存质点的位置，w 保存 ID
float4   g_vLifeStatus[ INSTANCENUM ];  // x 保存第一个
    ...
    pass P0
      {
        ...
        DestBlend         = One;//DestAlpha;//InvSrcAlpha;//One;//DestAlpha;
        //BlendOp           = Add;//RevSubtract;//Subtract;//Min;//Add;
