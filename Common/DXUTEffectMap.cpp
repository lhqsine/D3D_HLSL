...
HRESULT CDXUTEffectMap::SetStandardParameter( const WCHAR* strSemantic, 
  const WCHAR* strObject, DWORD dwObjectIndex, float* pData, DWORD dwDataLen, 
  const WCHAR* strType, const WCHAR* strUnits, const WCHAR* strSpace )
  {
...
HRESULT CDXUTEffectMap::SetStandardParameter( DXUT_SEMANTIC eSemantic, 
  DXUT_OBJECT eObject, DWORD dwObjectIndex, float* pData,  DWORD dwDataLen,  const WCHAR* strType, 
  const WCHAR* strUnits, const WCHAR* strSpace )
  {
    HRESULT hr;
...
HRESULT CDXUTEffectMap::UpdateTransforms( DXUT_SEMANTIC eSemantic, const WCHAR* strUnits )
  {
    ...
    if( eSemantic == DXUT_World ||  eSemantic == DXUT_View )
      {
