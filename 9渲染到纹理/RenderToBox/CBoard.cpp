...
HRESULT CBOARD::OnCreateDevice( IDirect3DDevice9* pd3dDevice )
  {
    ...
    if( FAILED( hr = D3DXCreateEffectFromFile( pd3dDevice , L"FileFX.fx" , NULL , NULL , dwFlag , NULL , &m_pEffect , &pCode )))    
      {
...
void CBOARD::OnFrameRender( IDirect3DDevice9* pd3dDevice , IDirect3DCubeTexture9* pTexture , int i )
  {
    HRESULT hr;
    switch( i )
      {
