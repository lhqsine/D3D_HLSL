...
//        { 0, 24, D3DDECLTYPE_FLOAT2, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_TEXCOORD, 0   },
    ...
    if( FAILED( hr = D3DXCreateVolumeTextureFromFile( pd3dDevice ,szFile ,&m_pVolumeTexture ))) return hr;
...
HRESULT CRENDEROBJECT::OnResetDevice( )
  {
    ...
    if( FAILED( hr = m_pEffect->SetTexture( "g_VolumeTexture", m_pVolumeTexture ))) return hr;
    return hr;
  }
