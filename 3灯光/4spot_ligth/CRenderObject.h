...
class CRENDEROBJECT
  {
    ...
    public:
      ...
      void  SetLightParament( D3DXVECTOR4* vPosition ,D3DXVECTOR4* vDirect );
      //
      void    Init( );
      ...
      void    OnFrameMove( D3DXMATRIXA16* pWorld ,D3DXMATRIXA16* pView ,D3DXMATRIXA16* pProject ,double fTime ,D3DXVECTOR4* , D3DXVECTOR4* );
