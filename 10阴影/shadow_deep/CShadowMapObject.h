...
#ifndef _SHADOWMAPOBJECT_H
#define _SHADOWMAPOBJECT_H
...
class CSHADOWMAPOBJECT
  {
    ...
    public:
      ...
      //LPDIRECT3DTEXTURE9  ReturnColorTexture( ) { return m_pColorTexture; }
      /*
      D3DXMATRIX* ReturnMatrixRTT( ) 
        {
          D3DXMATRIX matOut[ 3 ];
          matOut[ 0 ] = m_matWorldRTT;
          matOut[ 1 ] = m_matViewRTT;
          matOut[ 2 ] = m_matProjectRTT;
          return matOut;
        }
      */
      HRESULT SetLightParament( D3DXVECTOR3* , D3DXVECTOR3* , D3DXVECTOR3* );
      //
      void    Init( );
