...
HRESULT CDXUTMesh::Render( ID3DXEffect *pEffect,
  D3DXHANDLE hTexture,  D3DXHANDLE hDiffuse,  D3DXHANDLE hAmbient,  D3DXHANDLE hSpecular,
  D3DXHANDLE hEmissive, D3DXHANDLE hPower,  bool bDrawOpaqueSubsets,  bool bDrawAlphaSubsets )
  {
    if( NULL == m_pLocalMesh )
      return E_FAIL;
    UINT cPasses;
...
HRESULT CDXUTMeshFile::LoadFrame( LPDIRECT3DDEVICE9 pd3dDevice,
  LPD3DXFILEDATA pFileData, CDXUTMeshFrame* pParentFrame )
  {
