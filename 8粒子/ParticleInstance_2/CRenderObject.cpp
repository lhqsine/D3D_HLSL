...
// pCamPosition 是世界坐标系中的摄影机位置，pBillBoardPt 是世界坐标系中 BillBoard 的位置
void CRENDEROBJECT::OnFrameMove( D3DXMATRIXA16* pWorld ,D3DXMATRIXA16* pView ,D3DXMATRIXA16* pProject ,
  double fTime , D3DXVECTOR3* pCameraPosition , D3DXVECTOR3* pBillBoardPosition )
  {
    HRESULT hr = S_OK;
    hr = m_pEffect->SetMatrix( "g_matWorld", pWorld ) ;
    hr = m_pEffect->SetMatrix( "g_matView", pView ) ;
    ...
    D3DXVECTOR4 v4BillBoardPosition = D3DXVECTOR4( pBillBoardPosition->x , pBillBoardPosition->y , pBillBoardPosition->z , 1.0f );
